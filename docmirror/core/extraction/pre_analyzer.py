...
class PreAnalyzer:
    ...
    def analyze(self, fitz_doc) -> PreAnalysisResult:
        ...
        for idx in sample_pages:
            ...
            table_detection_pairs.append((idx, stats["has_table"], stats["table_count"]))
            # Collect structural fingerprints (for layout homogeneity detection)
            page_fingerprints.append((stats["x_column_count"], stats["has_table"], stats["text_blocks"]))
        ...
        result = PreAnalysisResult(
            ...
            avg_image_quality=(
                int(sum(image_quality_scores) / len(image_quality_scores)) if image_quality_scores else 100
            ),
    ...
    def _build_strategy_params(
        ...
        params["skip_watermark_filter"] = content_type == "text_dominant" and quality_score >= 0.9

        # Docling: consider enabling for standard/deep with text layer
        params["enable_docling"] = strategy in ("standard", "deep") and has_text
        ...
        params["reuse_first_page_structure"] = layout_homogeneous and content_type == "table_dominant"
